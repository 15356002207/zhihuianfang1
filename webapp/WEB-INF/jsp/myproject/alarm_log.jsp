...
<head>
	...
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=QD5lkZE1XSWGI44C5V3zhuMgp8ThDkzm"></script>
</head>  
...
<aos:onready>
	...
	var XMLHttpReq;
	 ...
	 // 处理返回信息函数
	    ...
	    var num2;
	    num1=test();
	    num2=_datagridpanel_store.getTotalCount();
	    ...
	    var info = Ext.util.Cookies.get('juid');
	    Ext.Ajax.request({
    url: '/zhaf/http/do.jhtml?router=alarm_logService.updateWebpage&juid='+info,
    async:false, 
    mathod:"POST",
	...
	return result;
	  ...
	  DisplayHot();
		...
		var count = _datagridpanel_store.getTotalCount();
       ...
       Ext.Ajax.request({
			    ...
			    success: function(response){
			      ...
			      var video1=	new Ext.Panel({  
	                   ...
	                   width:320,
	                   buttonAlign:'right',
	                   html : '<video id="myPlayer1" poster="" controls playsInline webkit-playsinline autoplay width="315" height="200">'  
                        ...
                        buttons:[{
                         	 ...
                         	 text : '最大化',
                         	handler: function () {window.open("<%=path%>/zhaf/video/control.html?vehicleId="+par[0],"","modal=yes,fullscreen=1");AOS.tip(rtmp[0])}
                         	 }]    
			    ...
			    var video2=	new Ext.Panel({  
                  ...
                  width:320,
                  buttonAlign:'right',
                  html : '<video id="myPlayer2" poster="" controls playsInline webkit-playsinline autoplay width="315" height="200">'  
                   ...
                   buttons:[{
                    	 ...
                    	 xtype : 'button',
                    	 text : '最大化',
                    	handler: function () {window.open("<%=path%>/zhaf/video/control.html?vehicleId="+par[1],"","modal=yes,fullscreen=1");AOS.tip(rtmp[0])}
                    	 }]    
			    ...
			    var video3=	new Ext.Panel({  
                  ...
                  width:320,
                  buttonAlign:'right',
                  html : '<video id="myPlayer3" poster="" controls playsInline webkit-playsinline autoplay width="315" height="200">'  
                   ...
                   buttons:[{
                    	 ...
                    	 xtype : 'button',
                    	 text : '最大化',
                    	handler: function () {window.open("<%=path%>/zhaf/video/control.html?vehicleId="+par[2],"","modal=yes,fullscreen=1");AOS.tip(rtmp[0])}
                    	 }]    
			    ...
			    var video4=	new Ext.Panel({  
                  ...
                  width:320,
                  buttonAlign:'right',
                  html : '<video id="myPlayer4" poster="" controls playsInline webkit-playsinline autoplay width="315" height="200">'  
                   ...
                   buttons:[{
                    	 ...
                    	 xtype : 'button',
                    	 text : '最大化',
                    	handler: function () {window.open("<%=path%>/zhaf/video/control.html?vehicleId="+par[3],"","modal=yes,fullscreen=1");AOS.tip(rtmp[0])}
                    	 }]    
			    ...
			    var video5=	new Ext.Panel({  
                  ...
                  width:320,
                  buttonAlign:'right',
                  html : '<video id="myPlayer5" poster="" controls playsInline webkit-playsinline autoplay width="315" height="200">'  
                   ...
                   buttons:[{
                    	 ...
                    	 xtype : 'button',
                    	 text : '最大化',
                    	handler: function () {window.open("<%=path%>/zhaf/video/control.html?vehicleId="+par[4],"","modal=yes,fullscreen=1");AOS.tip(rtmp[0])}
                    	 }]    
			    ...
			    var video6=	new Ext.Panel({  
                  ...
                  width:320,
                  buttonAlign:'right',
                  html : '<video id="myPlayer6" poster="" controls playsInline webkit-playsinline autoplay width="315" height="200">'  
                   ...
                   buttons:[{
                    	 ...
                    	 xtype : 'button',
                    	 text : '最大化',
                    	handler: function () {window.open("<%=path%>/zhaf/video/control.html?vehicleId="+par[5],"","modal=yes,fullscreen=1");AOS.tip(rtmp[0])}
                    	 }]    
